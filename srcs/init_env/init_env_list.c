 ...
 *
 * @description:
 *   Ajoute un nouvel élément à la fin d'une liste chaînée de type t_env.
 *   Cette fonction parcourt la liste jusqu'à atteindre le dernier élément,
 *   puis y attache le nouvel élément, permettant l'extension dynamique de
 *   la liste.
 */
...
/**
 * @description:
 *   Crée une liste chaînée à partir d'un tableau d'environnements. Cette
 *   fonction convertit les variables d'environnement fournies sous forme 
 *   de tableau de chaînes en une liste chaînée de type t_env, facilitant 
 *   leur manipulation et leur accès au sein du programme.
 */
