 ...
 *
 * @fonctionnement:
 *   Vérifie si les lexèmes indiquent un here-doc (LESS_DBE et LIMITOR). Si oui, 
 ...
 *   t_lexer *lex_lst = create_lexer_list("commande << LIMITOR");
 ...
 *
 * @fonctionnement:
 *   Vérifie si les lexèmes indiquent une redirection de sortie de type append (GR_DBE).
 ...
 *
 * @fonctionnement:
 *   Vérifie si les lexèmes actuels indiquent une redirection de sortie standard (GR).
